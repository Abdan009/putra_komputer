...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Putra Komputer</b>.ID</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('category.index') }}"> <i class="fa  fa-columns"></i> <span>Category</span></a></li>
       <li class="treeview ">
          <a href="#">
        ...
        <li><a href="{{ route('media.index') }}"> <i class="fa fa-folder"></i> <span>Media</span></a></li>
        <li><a href="{{ route('transaction.index') }}"> <i class="fa fa-shopping-cart"></i> <span>Transaction</span></a></li>
         <li class="treeview ">
          <a href="#">
        ...
        <li><a href="/"><i class="fa fa-circle-o text-red"></i> <span>Visit Website</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
